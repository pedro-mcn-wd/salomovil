...
$(document).ready(function() {
    ...
    $('#images_products').on('change', function() {
        ...
        var imgsUploaded = parseInt($('#countImages').text());
        var maxImages = 10 - imgsUploaded;
        ...
        if (files.length > remainingSlots) {
            alert('Cada producto solo puede tener 10 imagenes.');
        ...
        for (var i = 0; i < files.length; i++) {
            ...
            var promise = new Promise(function(resolve, reject) {
                reader.onload = function(e) {
                    $('#container_prev').hasClass('hidden') ? $('#container_prev').removeClass('hidden') : "";
