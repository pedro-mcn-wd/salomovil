...
@section('content')
    <div class="container mx-auto flex flex-col h-screen justify-between max-w-screen-xl">
                ...
                <div
                    ...
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        <div class="mb-4 text-sm text-gray-600 text-justify">
                            {{ __('¿Has olvidado tu contraseña? No te preocupes. Indícanos tu dirección de correo electrónico y te enviaremos un enlace para restablecer la contraseña que te permitirá elegir una nueva.') }}
                        </div>
                        <h1
