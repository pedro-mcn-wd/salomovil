    ...
    <form
        ...
        <div class="text-center group">
            <button type="button"
                ...
                data-drawer-target="drawer_filters_md" data-drawer-show="drawer_filters_md" data-drawer-placement="top"
                aria-controls="drawer_filters_md">
        ...
        <div id="drawer_filters_md"
            ...
            <div class="grid grid-cols-2 gap-4 w-full">
                ...
                <div class="col-span-2">
                    <h5 class="inline-flex items-center text-base font-semibold text-gray-500">{{ __('Datos') }}</h5>
                </div>
                ...
                <div class="col-span-2 grid grid-cols-4 gap-4">
                    <div class="grid gap-6 border border-gray-300 rounded-xl p-3">
                        {{-- category --}}
                        <div>
                            <label for="category" class="text-base font-semibold text-gray-500">{{ __('Categoría') }}</label>
                        ...
                        {{-- subcategory --}}
                        <div>
                            <label for="subcategory" class="text-base font-semibold text-gray-500">{{ __('Subcategoría') }}</label>
                            <div class="relative w-full">
                                <select name="subcategory" id="subcategory"
                                    class="mt-2 select_filter bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg  block w-full p-2.5 ">
                                    <option value="" data-cat_id="0">{{ __('Todas') }}</option>
                    ...
                    <div class="grid gap-6 border border-gray-300 rounded-xl p-3">
                        {{-- min_stock --}}
                        <div>
                            <label for="min_stock" class="text-base font-semibold text-gray-500">{{ __('Stock Mínimo') }}</label>
                            <input type="number" name="min_stock" id="min_stock"
                                ...
                                value="{{ $old_values['values_filters']['min_stock'] }}" min=0 placeholder="0">
                        </div>

                        {{-- max_stock --}}
                        <div>
                            <label for="max_stock" class="text-base font-semibold text-gray-500">{{ __('Stock Máximo') }}</label>
                            <input type="number" name="max_stock" id="max_stock"
                                class="mt-2 input_filter bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg  block w-full p-2.5  "
                                value="{{ $old_values['values_filters']['max_stock'] }}" min=0 placeholder="0">
                        </div>
                    </div>
                    ...
                    <div class="grid gap-6 border border-gray-300 rounded-xl p-3">
                        {{-- min_price --}}
                        <div>
                            <label for="min_price" class="text-base font-semibold text-gray-500">{{ __('Precio Mínimo') }}</label>
                            <input type="number" name="min_price" id="min_price"
                                class="mt-2 input_filter bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg  block w-full p-2.5  "
                                value="{{ $old_values['values_filters']['min_price'] }}" min=0 placeholder="0">
                        </div>

                        {{-- max_price --}}
                        <div>
                            <label for="max_price" class="text-base font-semibold text-gray-500">{{ __('Precio Máximo') }}</label>
                            <input type="number" name="max_price" id="max_price"
                                class="mt-2 input_filter bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg  block w-full p-2.5  "
                                value="{{ $old_values['values_filters']['max_price'] }}" min=0 placeholder="0">
                        </div>
                    </div>
                    ...
                    <div class="grid gap-6 border border-gray-300 rounded-xl p-3">
                        {{-- sort_in_order --}}
                        <div>
                            <label for="sort_in_order" class="text-base font-semibold text-gray-500">Ordenar en sentido</label>
                        ...
                        {{-- sort_by_field --}}
                        <div>
                            <label for="sort_by_field" class="text-base font-semibold text-gray-500">Por</label>
